            ...
            <div className="relative md:w-1/2 w-11/12">
                ...
                <div className="bg-slate-800 rounded p-20 border-rose-300 border-2 shadow-lg shadow-green-500/50 relative">
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 text-center gap-3">
                        <h3 className="cursor-pointer font-arima text-xl p-8 px-20 m-3 bg-gray-400 border-gray-600 rounded-3xl hover:bg-gray-300 transition-all duration-300 ease-linear hover:rounded-xl md:h-64 ">
                            Korean Hangman
                        </h3>
                        <h3 className="cursor-pointer font-arima text-xl p-8 px-20 m-3 bg-gray-400 border-gray-600 rounded-3xl hover:bg-gray-300 transition-all duration-300 ease-linear hover:rounded-xl md:h-64">
                            League-info
